...
* Check if your build is the latest on our Jenkins. Click Here: <https://host.areaz12server.net.br:8080/job/RankUpper>
...
**Server and plugins versions (please complete the following information):**
 ...
 - Plugin Version: [e.g. RankUpper-4.0.3-b18-Universal.jar]
